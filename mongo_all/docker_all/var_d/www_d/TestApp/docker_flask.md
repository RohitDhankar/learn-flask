...
```
#
- within the browser at address - http://localhost:56733/
> Hello World from Flask in a uWSGI Nginx Docker container with Python 3.8 (default)

#
- make changes to -- views.py --- restart container 
...
$ sudo docker ps
CONTAINER ID        IMAGE               COMMAND                  CREATED             STATUS              PORTS                            NAMES
89db6ffe627c        docker.test         "/entrypoint.sh /sta…"   About an hour ago   Up 5 seconds        443/tcp, 0.0.0.0:56733->80/tcp   docker.test
b664208c5e60        redis               "docker-entrypoint.s…"   2 months ago        Up 3 hours          6379/tcp                         broker
