...
double free or corruption (out)
SIGABRT: abort
PC=0x7f87cf739f47 m=0 sigcode=18446744073709551610
signal arrived during cgo execution

goroutine 1 [syscall, locked to thread]:
runtime.cgocall(0x4afd50, 0xc42004fcc0, 0xc42004fce8)
	/usr/lib/go-1.8/src/runtime/cgocall.go:131 +0xe2 fp=0xc42004fc90 sp=0xc42004fc50
github.com/docker/docker-credential-helpers/secretservice._Cfunc_free(0x1c42920)
	github.com/docker/docker-credential-helpers/secretservice/_obj/_cgo_gotypes.go:111 +0x41 fp=0xc42004fcc0 sp=0xc42004fc90
github.com/docker/docker-credential-helpers/secretservice.Secretservice.List.func5(0x1c42920)
	/build/golang-github-docker-docker-credential-helpers-cMhSy1/golang-github-docker-docker-credential-helpers-0.5.0/obj-x86_64-linux-gnu/src/github.com/docker/docker-credential-helpers/secretservice/secretservice_linux.go:96 +0x60 fp=0xc42004fcf8 sp=0xc42004fcc0
github.com/docker/docker-credential-helpers/secretservice.Secretservice.List(0x0, 0x756060, 0xc42008a000)
	/build/golang-github-docker-docker-credential-helpers-cMhSy1/golang-github-docker-docker-credential-helpers-0.5.0/obj-x86_64-linux-gnu/src/github.com/docker/docker-credential-helpers/secretservice/secretservice_linux.go:97 +0x217 fp=0xc42004fda0 sp=0xc42004fcf8
github.com/docker/docker-credential-helpers/secretservice.(*Secretservice).List(0x77e548, 0xc42004fe88, 0x410022, 0xc4200142e0)
	<autogenerated>:4 +0x46 fp=0xc42004fde0 sp=0xc42004fda0
github.com/docker/docker-credential-helpers/credentials.List(0x756ba0, 0x77e548, 0x7560e0, 0xc42000e018, 0x0, 0x10)
	/build/golang-github-docker-docker-credential-helpers-cMhSy1/golang-github-docker-docker-credential-helpers-0.5.0/obj-x86_64-linux-gnu/src/github.com/docker/docker-credential-helpers/credentials/credentials.go:145 +0x3e fp=0xc42004fe68 sp=0xc42004fde0
github.com/docker/docker-credential-helpers/credentials.HandleCommand(0x756ba0, 0x77e548, 0x7ffc99840801, 0x4, 0x7560a0, 0xc42000e010, 0x7560e0, 0xc42000e018, 0x40e398, 0x4d35c0)
	/build/golang-github-docker-docker-credential-helpers-cMhSy1/golang-github-docker-docker-credential-helpers-0.5.0/obj-x86_64-linux-gnu/src/github.com/docker/docker-credential-helpers/credentials/credentials.go:60 +0x16d fp=0xc42004fed8 sp=0xc42004fe68
github.com/docker/docker-credential-helpers/credentials.Serve(0x756ba0, 0x77e548)
	/build/golang-github-docker-docker-credential-helpers-cMhSy1/golang-github-docker-docker-credential-helpers-0.5.0/obj-x86_64-linux-gnu/src/github.com/docker/docker-credential-helpers/credentials/credentials.go:41 +0x1cb fp=0xc42004ff58 sp=0xc42004fed8
main.main()
...
Step 1/5 : FROM tiangolo/uwsgi-nginx-flask:python3.8-2020-08-16
 ---> 66052e3b6bb0
Step 2/5 : ENV STATIC_URL /static
 ---> Running in 5b13d571892b
Removing intermediate container 5b13d571892b
 ---> 985edbc490a9
Step 3/5 : ENV STATIC_PATH /var_d/www_d/app/static
 ---> Running in 8b54fe90bdc7
Removing intermediate container 8b54fe90bdc7
 ---> fd3997af302e
Step 4/5 : COPY ./requirements.txt /var_d/www_d/requirements.txt
 ---> 44cb92871a28
Step 5/5 : RUN pip install -r /var_d/www_d/requirements.txt
 ---> Running in 2f30f0cc958b
Requirement already satisfied: Flask==1.1.2 in /usr/local/lib/python3.8/site-packages (from -r /var_d/www_d/requirements.txt (line 1)) (1.1.2)
Requirement already satisfied: Jinja2>=2.10.1 in /usr/local/lib/python3.8/site-packages (from Flask==1.1.2->-r /var_d/www_d/requirements.txt (line 1)) (2.11.2)
Requirement already satisfied: Werkzeug>=0.15 in /usr/local/lib/python3.8/site-packages (from Flask==1.1.2->-r /var_d/www_d/requirements.txt (line 1)) (1.0.1)
Requirement already satisfied: itsdangerous>=0.24 in /usr/local/lib/python3.8/site-packages (from Flask==1.1.2->-r /var_d/www_d/requirements.txt (line 1)) (1.1.0)
Requirement already satisfied: click>=5.1 in /usr/local/lib/python3.8/site-packages (from Flask==1.1.2->-r /var_d/www_d/requirements.txt (line 1)) (7.1.2)
Requirement already satisfied: MarkupSafe>=0.23 in /usr/local/lib/python3.8/site-packages (from Jinja2>=2.10.1->Flask==1.1.2->-r /var_d/www_d/requirements.txt (line 1)) (1.1.1)
WARNING: You are using pip version 20.1; however, version 20.2.3 is available.
You should consider upgrading via the '/usr/local/bin/python -m pip install --upgrade pip' command.
Removing intermediate container 2f30f0cc958b
 ---> 8a9044f0b27a
Successfully built 8a9044f0b27a
Successfully tagged docker.test:latest
---DHANKAR---app==docker.test--build -t --Done-
89db6ffe627c3c274eaf51a3c469decf657f22aa8df1f5f2a15e8fa5f3e8c5ad
(base) dhankar@dhankar-1:~/learn-flask/mongo_all/docker_all/var_d/www_d/TestApp$ 
(base) dhankar@dhankar-1:~/learn-flask/mongo_all/docker_all/var_d/www_d/TestApp$ sudo docker ps
CONTAINER ID        IMAGE               COMMAND                  CREATED             STATUS              PORTS                            NAMES
89db6ffe627c        docker.test         "/entrypoint.sh /sta…"   47 seconds ago      Up 44 seconds       443/tcp, 0.0.0.0:56733->80/tcp   docker.test
b664208c5e60        redis               "docker-entrypoint.s…"   2 months ago        Up 2 hours          6379/tcp                         broker


```
- doesnt seem to be right --- isnt the image supposed to have its own internal to the Docker Container installs of the Python packages - example Flask . 
- Why are my local system -- /usr/local/lib/python3.8/site-packages , being reffered above ?? 
#
```
